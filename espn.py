...
for index in range(len(users)):
	with open('account_results','a') as account_results:
		try:
			...
			original_login = browser.find_element_by_xpath('//*[@id="did-ui-view"]/div/footer/p/a')
			...
			time.sleep(1)
			password_box = browser.find_element_by_xpath('//*[@id="did-ui-view"]/div/section/section/form/section/div[2]/div/label/span[2]/input')
