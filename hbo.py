...
while index != len(users):
	with open('accounts/hbo_working_accounts','a') as account_results:
		try:
			...
			sign_in_button = browser.find_element_by_xpath('//*[@id="root"]/div[1]/div[2]/div/div[2]/div/div/div[1]/div/div[2]/div[2]/div/div/div/div[1]/div/div/div/div[2]/div[1]/div[4]/div[1]/div')					
